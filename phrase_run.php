<?PHP /* Author: Aninu Alin / 2016 */ require('phrase_function.php'); ?>
<html>
	<head>
		<title> The logic of the Propositions </title>
		<style>
			table {
	...
	<body>
		<div class="size">
			<b>The logic of the Propositions:</b>
			<hr/>
			<table width="100%">
		...
		<?PHP if(GPost("submit")){ echo '<div class="w3-panel w3-note"><p>';  p_exist(p_check(GPost("prop"))); echo '</p></div>'; } ?>
	</body>
</html>